...
const networkConfig = {
    testnet: {
        ...
        contractAddress: '0x94bC53fD2D7915fD70A120eBfb96bB99A81fFfeF', // अपना स्टेकिंग कॉन्ट्रैक्ट एड्रेस
        vnstTokenAddress: '0x37c401DdBC8030c63BF3B3b2816Ba379BfD10474', // अपना VNST टोकन एड्रेस
...
async function checkNetwork() {
    try {
        ...
        showError("Please connect to Binance Smart Chain");
    }
}
...
async function smartStake() {
    ...
    try {
        ...
        if (BigInt(userBalance) < BigInt(amountWei)) {
            showError("Insufficient VNST balance");
            return;
        }
...
// ABIs - इन्हें अपनी फाइल में कॉपी-पेस्ट करें
